...
const FIELD_STYLE =
  "font-size: 16px; line-height: 1.4; width: 100%; padding: 12px 14px; border: 1px solid #d8d2c7; border-radius: 0; background: #ffffff; color: #1a1815; box-shadow: none; transition: border-color 0.15s ease;";
