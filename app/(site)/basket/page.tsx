...
export default async function BasketPage() {
  ...
  return <><div className="band"><div className="container" style={{ padding: "52px 40px" }}><div className="page-head"><div className="he he--left" lang="he">רשימת הכיבודים</div><h1>Your sponsorship list</h1><div className="meta">Sponsor several kibbudim with one secure Admire payment.</div></div></div></div><PhotoBand photo="basket-seforim" slim priority /><section className="container" style={{ padding: "48px 40px 96px" }}><CartCheckoutExperience items={items} admireCampaignId={admireCampaignId} turnstileSiteKey={turnstileSiteKey} /></section></>;
}
